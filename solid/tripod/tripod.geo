...
Physical Surface("clamped") = {311, 381, 379};
Physical Surface("free") = {367, 383, 369, 385, 331, 333, 335, 397, 38, 42, 377, 310, 375, 302, 400, 132, 128, 83, 87, 371, 373, 389, 387};
Physical Surface("pressure") = {406, 404, 402, 337};
Physical Volume("tripod") = {408};
